    ...
    function UIDropdownCDLNode (config) {
        ...
        const evts = {
            ...
            onInput: function (msg, send, done) {
                ...
                // ignore this if msg._updates present
                if (msg._updates) {
                    //console.log(`ignoring`)
                    // this is a message generated by the code below and fed back in again for it to be sent to the clients
                    ...
                    // if we have any updates, save them in the state store then s
                    if (updatesPresent) {
                        ...
                        // send them back to our input, which will drop through and sent them to the clients
                        node.emit('input',{_updates: updates})
                    }
